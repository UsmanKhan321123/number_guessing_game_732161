...
if (
  user_guessed_number.user_guessed_number > 0 &&
  ...
  if (user_guessed_number.user_guessed_number === computer_guessed_number) {
    ...
    console.log(
      `Your guessed number was ${user_guessed_number.user_guessed_number} and computer guessed number was ${computer_guessed_number}`
    );
  } else {
